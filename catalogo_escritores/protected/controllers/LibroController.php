...
class LibroController extends Controller
{
	...
	public function actionIndex()
	{
		...
		// ));
		$sql = "SELECT l.id_libro,l.titulo,l.noPaginas,l.id_escritor,e.nombre,e.apellido_paterno,e.apellido_materno FROM libro l, escritor e WHERE l.id_escritor=e.id_escritor ORDER BY titulo ASC";
	    $libros = Yii::app()->db->createCommand($sql)->queryAll();
        $this->render('index',array('libros'=>$libros));
	}
